    ...
    @section('content')
        ...
        <section class="relative py-24 overflow-hidden bg-[#04040f] text-white">
            ...
            <div class="absolute inset-0 opacity-40">
                <div
                    class="absolute w-[700px] h-[700px] bg-purple-600 rounded-full blur-[140px] top-[-200px] left-[-200px]">
                </div>
                <div
        ...
        <section
            class="section py-10 md:py-20 min-h-[70vh] md:h-[88vh] flex items-center justify-center bg-cover bg-center"
